...
module.exports = class HouseholdMeterDevice extends SonnenDevice {
  ...
  private readonly handleUpdateEvent = (currentState: any, statusJson: any): void => {
    ...
    this.setCapabilityValue('consumption_today_min_capability',
      currentState.todayMinConsumption_Wh === Number.MAX_SAFE_INTEGER
        ? 0
        : currentState.todayMinConsumption_Wh);
